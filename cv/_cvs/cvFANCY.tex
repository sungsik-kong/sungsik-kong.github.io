...
\begin{longtable}{p{0.25\textwidth}  p{0.85\textwidth}}
...
%22%Network Inference Software KONG;  MBE/Bioinformatics
%23%One with Claudia & CH#3 Syst Biol
%24%One with Jeremy -- the teaching tool BSSB
%25%One with Claudia Extended Newick Format
%26%PhyNE Network rooting using site patterns method 
%27%Hybrid detection method using gene trees
%28%TICR vs GHDet
%29%Review of metagenomic methods for vertebrates
%30%Phylogenetic placement method developemt
%31%Metagenomic methods comparison
%32%Santiago collaboration
%33%Network consensus method
%33%PhyNE using quintet
%34%PhyNE using relaxed molecular clock
%35%PhyNE ambiguous sites
	...
	\item \textbf{Kong S}, Swofford DL, and Kubatko LS. (In Review) Inference of phylogenetic networks from sequence data using composite likelihood. %Syst Biol Available on \textit{bioRxiv} \href{https://doi.org/10.1101/2022.10.01.510440}10.1101/2022.10.01.510440
		
	\item Fu M, Eimes JA, \textbf{Kong S}, Lamichhaney S, and Waldman B. (In Review) Chytrid-resistant genotypes arise from multiple mutations. %Proceedings B

	\item \textbf{Kong S}, Sánchez-Pacheco SJ, and Murphy RW. (In Review) Topological incongruence between median-joining networks and Bayesian inference phylogenies. Available on \textit{bioRxiv} \href{https://doi.org/10.1101/2022.10.01.510440}10.1101/2022.10.01.510440 %BSSB	
