...
From 2023 & \textbf{Postdoctoral Scholar}\\
...
%24%One with Jeremy -- the teaching tool BSSB
	...
	\item Nguyen HQ, Ho P-T, \textbf{Kong S}, Bae Y, Pham TH, and Jang Y. (In Review) A time-calibrated mitogenomic phylogeny suggests that Korean \textit{Hyalessa fuscata} is a bridge between Chinese and Japanese \textit{H. maculaticollis}.
	...
	\item Glon H, Häussermann V, Brewin P, Brickle P, \textbf{Kong S}, Smith M, and Daly M. (In Revision) There and back again: The unexpected journeys of \textit{Metridium} de Blainville, 1824 between the old oceans and throughout the modern world. %The Biological Bulletin
...
2022 & \textbf{Kong S} Algorithms and Complexity in Phylogenetics, virtual\\
