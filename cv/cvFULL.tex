...
%199%Alec SHEETS; 
%20%Network Inference KONG; 
%21%Network Inference Software KONG;  
%22%Network Methods Comparison KONG; 
%23%One with Claudia
%24%One with Jeremy -- the teaching tool
%25%One with Emanuel -- Amazon Lizards
	...
	\item Nguyen HQ, Kim E, Bae Y, Char S, Ji S, Heo J, \textbf{Kong S}, Nguyen TK, Pham TH, and Jang Y. (In Review) An effective method for accurate life-stage delimitation of cicadas. %Journal of Asia-Pacific Entomology
...
\item Glon MG, Broe MB, Crandall KA, Daly M, \textbf{Kong S}, Thoma RF, and Freudenstein JV. (In Press) Anchored hybrid enrichment resolves the \textit{Lacunicambarus} (Decapoda: Cambaridae) phylogeny. \textit{Journal of Crustacean Biology} doi: \href{https://doi.org/10.1093/jcbiol/ruab073}10.1093/jcbiol/ruab073
