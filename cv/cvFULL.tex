...
%22%Network Inference Software KONG;  
%23%Network Methods Comparison KONG; 
%24%One with Jeremy -- the teaching tool
%25%One with Claudia


	\item \textbf{Kong S}, Swofford DL, and Kubatko LS. (In Preparation) Inference of phylogenetic networks from sequence data using composite likelihood. %Syst Biol/MBE?
	...
	\item Nguyen HQ, Ho P-T, \textbf{Kong S}, and Jang Y. (In Preparation) Mitochondrial phylogenomics suggests \textit{Hyalessa fuscata} not a synonym of \textit{Hyalessa maculaticollis} (Hemiptera: Cicadidae).
	...
	\item Nguyen HQ, Kim E, Bae Y, Chae S, Ji S, Heo J, \textbf{Kong S}, Nguyen TK, Pham TH, and Jang Y. (In Review) An effective method for accurate life-stage delimitation of cicadas. %Journal of Asia-Pacific Entomology

	\item \textbf{Kong S} (In Review) Digest: Frequent hybridization in \textit{Darevskia} rarely leads to the evolution of asexuality. %Evolution
...
\item \textbf{Kong S}$^\dag$, Pons JC$^\dag$, Kubatko LS, and Wicke K. (In Press) Classes of phylogenetic networks and their mathematical and biological significance. \textit{Journal of Mathematical Biology} 84:47 doi: \href{https://doi.org/10.1007/s00285-022-01746-y}10.1007/s00285-022-01746-y
...
\begin{longtable}{p{0.15\textwidth}  p{0.85\textwidth}}
%2022		   & \textbf{Visiting Scholar} Dr. Claudia Solís-Lemus Lab, University of Wisconsin, Madison, WI., USA\\
...
2022 & \textbf{Symposium Organizer} Towards the Network of Life: Phylogenetic Networks as a Tool to Understand Complex Evolutionary Histories, Evolution Meeting, Cleveland, OH., USA\\
