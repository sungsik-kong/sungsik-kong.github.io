...
## Summary <a href="/cv/cv.pdf" target="popup">[cv]</a>
...
<p><a href="academictree.html" target="popup" onclick="window.open('../html-link.htm','name','width=800,height=800')">You can see my academic tree here!</a></p>
